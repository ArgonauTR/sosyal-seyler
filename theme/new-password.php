<div class="m-4 p-4">
    ...
    <form action="./functions/new-password.php" method="POST">
        <div class="mb-3 mt-4">
            <p>
                Merhaba <b><?php echo $nick ?></b>,
                <br>
                Şifreni sıfırlamak üzersin.
            </p>
        </div>
        <div class="mb-3 mt-4">
            <input type="text" class="form-control" name="user_nick" value="<?php echo $nick ?>" hidden>
        </div>
        <div class="mb-3 mt-4">
            <input type="text" class="form-control" name="user_password_reset_key" value="<?php echo $key ?>" hidden>
        </div>
        <div class="mb-3 mt-4">
