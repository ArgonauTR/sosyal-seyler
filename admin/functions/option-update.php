...
// -----> Logo güncelleniyor
if (isset($_POST["option_logo_update"])) {
    ...
    if (isset($_FILES['resim']) && !empty($_FILES['resim']['name'])) { // Resim yüklenmişse bu kısım çalışır.
	    ...
	    */
        ...
        $son_resim_id = $_POST["option_logo_image_id"];
    }
    ...
    $update = $option->execute(array(
        ...
        'option_logo_image' => $son_resim_id
    ));
...
// ----->  Favicon güncelleniyor
if (isset($_POST["option_favicon_update"])) {
    ...
    if (isset($_FILES['resim']) && !empty($_FILES['resim']['name'])) { // Resim yüklenmişse bu kısım çalışır.
	    ...
	    */
        ...
        $son_resim_id = $_POST["option_favicon_image_id"];
    }
    ...
    $update = $option->execute(array(
        ...
        'option_favicon_image' => $son_resim_id
    ));
