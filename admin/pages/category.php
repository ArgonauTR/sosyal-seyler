...
<div class="col-lg-9">
    <div class="card bg-dark text-white">
        <div class="card-header">
            <a href="?status=blog" class="btn btn-sm btn-outline-secondary text-white ms-2 mt-2" style="text-decoration: none;"><i class="bi bi-pencil-square me-1"></i>Yazılar</a>
            <a href="?status=manga" class="btn btn-sm btn-outline-secondary text-white ms-2 mt-2" style="text-decoration: none;"><i class="bi bi-brilliance me-1"></i>Mangalar</a>
            <a href="./process.php?category=category-add" class="btn btn-sm btn-primary text-white ms-2 mt-2" style="text-decoration: none;"><i class="bi bi-plus-circle me-2"></i>Kategori Ekle</a>
        </div>
        <div class="card-body p-1">
            ...
            $categoryask = $db->prepare("SELECT * FROM categories WHERE category_status='$status' ORDER BY category_id DESC LIMIT $start_limit,$limit");
            $categoryask->execute(array());
            while ($categoryfetch = $categoryask->fetch(PDO::FETCH_ASSOC)) {
            ?>
