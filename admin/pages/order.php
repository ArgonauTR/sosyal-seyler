...
<div class="col-lg-9">
    <div class="card bg-dark text-white">
        ...
        <a href="./order.php?order=sidebar" class="btn btn-sm btn-outline-secondary mt-2 text-white ms-2" style="text-decoration: none;"><i class="bi bi-layout-sidebar-inset-reverse me-2"></i></i>Kenar Çubuğu</a>
        </div>
        <div class="card-body">
        <?php
